...
import numpy as np
import sys
sys.path.insert(0, "/workspaces/walking_quad/MCLR/src/exercise_01/simulator/")
sys.path.insert(0, "/workspaces/walking_quad/MCLR/src/project/walking/")
...
package_dirs = ["/workspaces/walking_quad/MCLR/src/project/go2_description"]
